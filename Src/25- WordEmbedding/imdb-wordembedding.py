...
# cv.vocabulary_[word] + 1--> padding için 0'ı boş bırakıyoruz

from tensorflow.keras.utils import pad_sequences

dataset_x = pad_sequences(text_vectors, TEXT_SIZE, padding="pre", dtype='float32', value=0.0)

dataset_y = (df['sentiment'] == 'positive').to_numpy(dtype='uint8')


# re.findall(r'(?u)\b\w\w+\b', text.lower()): text içinde iki veya daha fazla 
# karakterden oluşan tüm kelimeleri küçük harfli halde bulur ve bir liste olarak döndürür.
