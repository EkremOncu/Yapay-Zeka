...
auto_model = ak.AutoModel(inputs=inp, outputs=out, max_trials=10, overwrite=True)

# perceptron modeli oluşturuyor, kendi seçsin yapamadım
"""

inp = ak.Input()
output = ak.DenseBlock(num_layers=3)(inp)
